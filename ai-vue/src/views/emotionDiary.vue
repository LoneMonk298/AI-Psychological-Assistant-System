      ...
      <div class="diary-card">
        ...
        <div class="detail-form">
          ...
          <div class="form-group">
            ...
            <el-input v-model="diaryForm.diaryContent" type="textarea" placeholder="写下您今天的想法，感受或发生的有趣事情" :rows="5" maxlength="2000" show-word-limit></el-input>
          </div>
          <!-- 生活指标 -->
