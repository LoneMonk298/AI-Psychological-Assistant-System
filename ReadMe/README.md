...
1. 登录学习通资料下载7-zip解压缩软件并安装 <br>
   ![alt text](./image-2.png)
2. 登录学习通资料下载Steam++加速器，右键选择7-zip解压缩，解压缩到任意目录下 <br>
...
2. 双击安装包，点击登录GitHub账号 <br>
   ![alt text](./image-6.png) <br>
3. 登录后界面如下： <br>
   ![alt text](./image-7.png) <br>
4. GitHub Desktop使用步骤：[视频教程](https://www.bilibili.com/video/BV13W411U7HY?t=43.2 "点击观看") <br>
   多人协作开发：[视频教程](https://www.bilibili.com/video/BV1Enw8zMEk1?t=688.7 "点击观看") <br>
    <mark>请各位注册完Github账号后把邮箱发给我，我邀请你们进行协作开发。 </mark><br>
